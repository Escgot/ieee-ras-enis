...
export default function Team() {
  ...
  // IntersectionObserver for autoPlay (desktop only)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // AutoPlay only on desktop (>= 1024px) when in view & not hovered
    let autoPlay: ReturnType<typeof setInterval> | undefined;
    const isDesktop = window.innerWidth >= 1024;
    if (isDesktop && !isHovered && isInView) {
  ...
  return (
    ...
    >
      ...
      {/* Floating geometric decorations — desktop only via hidden/lg:block */}
      <div className="hidden lg:block absolute top-20 left-10 w-32 h-32 rounded-full border border-red-500/8 animate-rotate-slow pointer-events-none" />
      <div className="hidden lg:block absolute bottom-20 right-10 w-24 h-24 rounded-full border border-purple-500/8 animate-rotate-reverse pointer-events-none" />
      ...
      <div className="relative w-full z-10">
        ...
        <div className="px-0 sm:px-6 lg:px-12 max-w-[1700px] mx-auto w-full">
          <div className="relative">
            ...
            {/* Embla viewport — mask only on desktop to avoid mobile GPU cost */}
            <div
                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        style={{
                          boxShadow: isActive
                            ? '0 15px 50px rgba(239,68,68,0.3), 0 20px 80px rgba(0,0,0,0.4)'
            ...
            <div className="flex items-center justify-center gap-6 -mt-4">
              <button
                ...
                className="group w-12 h-12 flex items-center justify-center rounded-full border border-white/10 hover:border-red-500/50 bg-white/5 hover:bg-red-500/10 text-gray-400 hover:text-red-400 transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed"
                aria-label="Previous"
              >
